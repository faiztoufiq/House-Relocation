    ...
    <NavigationContainer independent={true}>
      <Stack.Navigator>
        ...
        <Stack.Screen
          ...
          component={CustomerDrawerContainer}
          options={{ headerShown: false }}
        />
        <Stack.Screen
          name="Team Sign In"
          component={SignInTeam}
          options={({ navigation }) => ({
            title: "Team Sign In",
            headerStyle: {
              backgroundColor: "#BF9000",
        ...
        <Stack.Screen
          ...
          component={EmployeeDrawerContainer}
          options={{ headerShown: false }}
        />
      </Stack.Navigator>
    </NavigationContainer>
